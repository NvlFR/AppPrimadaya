...
/**
* @see \App\Http\Controllers\CustomerController::customPrices
* @see app/Http/Controllers/CustomerController.php:125
* @route '/customers/{customer}/custom-prices'
*/
export const customPrices = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: customPrices.url(args, options),
    method: 'get',
})

customPrices.definition = {
    methods: ["get","head"],
...
* @route '/customers/{customer}/custom-prices'
*/
customPrices.url = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { customer: args }
    }
    ...
    return customPrices.definition.url
            .replace('{customer}', parsedArgs.customer.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/customers/{customer}/custom-prices'
*/
customPrices.get = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: customPrices.url(args, options),
    method: 'get',
})
...
* @route '/customers/{customer}/custom-prices'
*/
customPrices.head = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: customPrices.url(args, options),
    method: 'head',
})
...
* @route '/customers/{customer}/custom-prices'
*/
const customPricesForm = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: customPrices.url(args, options),
    method: 'get',
})
...
* @route '/customers/{customer}/custom-prices'
*/
customPricesForm.get = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: customPrices.url(args, options),
    method: 'get',
})
...
* @route '/customers/{customer}/custom-prices'
*/
customPricesForm.head = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: customPrices.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
customPrices.form = customPricesForm
...
const customers = {
    ...
    customPrices: Object.assign(customPrices, customPrices),
