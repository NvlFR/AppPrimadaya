...
* @see app/Http/Controllers/CustomerController.php:179
* @route '/customers/{customer}'
*/
...
/**
* @see \App\Http\Controllers\CustomerController::getCustomPrices
* @see app/Http/Controllers/CustomerController.php:125
* @route '/customers/{customer}/custom-prices'
*/
export const getCustomPrices = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getCustomPrices.url(args, options),
    method: 'get',
})

getCustomPrices.definition = {
    methods: ["get","head"],
    url: '/customers/{customer}/custom-prices',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/customers/{customer}/custom-prices'
*/
getCustomPrices.url = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { customer: args }
    }
    ...
    return getCustomPrices.definition.url
            .replace('{customer}', parsedArgs.customer.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/customers/{customer}/custom-prices'
*/
getCustomPrices.get = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: getCustomPrices.url(args, options),
    method: 'get',
})
...
* @route '/customers/{customer}/custom-prices'
*/
getCustomPrices.head = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: getCustomPrices.url(args, options),
    method: 'head',
})
...
* @route '/customers/{customer}/custom-prices'
*/
const getCustomPricesForm = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: getCustomPrices.url(args, options),
    method: 'get',
})
...
* @route '/customers/{customer}/custom-prices'
*/
getCustomPricesForm.get = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: getCustomPrices.url(args, options),
    method: 'get',
})
...
* @route '/customers/{customer}/custom-prices'
*/
getCustomPricesForm.head = (args: { customer: number | { id: number } } | [customer: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: getCustomPrices.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
getCustomPrices.form = getCustomPricesForm

/**
* @see \App\Http\Controllers\CustomerController::destroy
* @see app/Http/Controllers/CustomerController.php:216
* @route '/customers/{customer}'
*/
...
const CustomerController = { index, search, store, show, update, getCustomPrices, destroy }
